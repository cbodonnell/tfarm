module github.com/cbodonnell/tfarm

go 1.20

require (
	github.com/cbodonnell/oauth2utils v0.3.4
...
require (
	...
	github.com/cbodonnell/go-oidc/v3 v3.0.0-20230402151138-e145b78ff15d // indirect
